 ...
 * @LastEditors: skychx
 * @LastEditTime: 2021-02-17 15:18:48
...
// UnionBySizeUF 是基于集合中元素个数优化的
// UnionByHeightUF 基于树的层数优化
// PathCompressionUF 通过路径压缩（Path Compression）进一步降低树的高度
export class PathCompressionUF2 implements ToyUnionFind {
